		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Metisoft Fiori CPI",
									"targetURL": "#commetismetipiappui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commetismetipiappui-display": {
								"semanticObject": "commetismetipiappui",
								"action": "display",
								"description": "Metisoft Fiori App for CPI",
								"title": "Metisoft Fiori CPI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.metis.metipiappui",
									"url": sap.ui.require.toUrl("com/metis/metipiappui")
								}
							}
						}
					}
